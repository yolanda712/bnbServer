...
var backGroundMap = [ 
    ...
    [  S_W_1, GROUND, GROUND, GROUND, GROUND, GROUND,  GROUND, GROUND,  S_W_1,  GROUND,  GROUND,   S_W_1,GROUND,  GROUND, GROUND,GROUND, GROUND, GROUND,  GROUND,  S_W_1 ],
    [  S_W_1, S_W_1,  GROUND, GROUND, GROUND, GROUND,  GROUND, GROUND, GROUND,  GROUND,  GROUND, GROUND, GROUND,  GROUND,GROUND, GROUND, GROUND,  S_W_1,  GROUND,  S_W_1 ],
    [  S_W_1, GROUND, GROUND, GROUND,  GROUND, GROUND,   GROUND, GROUND, GROUND,  GROUND,  GROUND, GROUND, GROUND,  S_W_1, GROUND,  S_W_1, GROUND, GROUND,  GROUND,  S_W_1 ],
    [  S_W_1, GROUND, GROUND, GROUND, GROUND, GROUND,   GROUND, GROUND, GROUND,  GROUND,  GROUND, GROUND, GROUND,  S_W_1, GROUND, GROUND, GROUND, GROUND,  GROUND,  S_W_1 ],
    [  S_W_1, GROUND,  GROUND, GROUND, GROUND, GROUND,  GROUND, GROUND,  S_W_1,  GROUND,  GROUND,  S_W_1, GROUND, GROUND, GROUND, GROUND, GROUND,  S_W_1,  GROUND,  S_W_1 ],
    [  S_W_1, GROUND, GROUND, GROUND, GROUND, GROUND,   GROUND, GROUND, GROUND,  GROUND,  GROUND, GROUND, GROUND,  S_W_1, GROUND, GROUND, GROUND, GROUND,  GROUND,  S_W_1 ],
    [  S_W_1, GROUND, GROUND, GROUND,  GROUND, GROUND,   GROUND, GROUND, GROUND,  GROUND,  GROUND, GROUND, GROUND,  S_W_1, GROUND,  S_W_1, GROUND, GROUND,  GROUND,  S_W_1 ],
    [  S_W_1, GROUND, GROUND, GROUND, GROUND, GROUND,   GROUND, GROUND, GROUND,  GROUND,  GROUND, GROUND, GROUND,  S_W_1, GROUND,  S_W_1, GROUND, GROUND,  GROUND,  S_W_1 ],
    [  S_W_1, GROUND, GROUND, GROUND,  GROUND, GROUND,   GROUND, GROUND, GROUND,  GROUND,  GROUND, GROUND, GROUND,  S_W_1, GROUND, GROUND, GROUND, GROUND,  GROUND,  S_W_1 ],
    ...
    [  S_W_1, GROUND, GROUND, GROUND, GROUND, GROUND,   GROUND, GROUND, GROUND,  GROUND,  GROUND, GROUND, GROUND,  S_W_1, GROUND, GROUND, GROUND, GROUND,  GROUND,  S_W_1 ],
    [  S_W_1, GROUND, GROUND, GROUND, GROUND, GROUND,   GROUND, GROUND, GROUND,  GROUND,  GROUND, GROUND, GROUND,  S_W_1, GROUND,  S_W_1, GROUND, GROUND,  GROUND,  S_W_1 ],
    [  S_W_1, GROUND,  GROUND, GROUND,  GROUND, GROUND,  GROUND, GROUND, GROUND,  GROUND,  GROUND, GROUND, GROUND, GROUND, GROUND, GROUND, GROUND,  S_W_1,  GROUND,  S_W_1 ],
    [  S_W_1, GROUND, GROUND, GROUND, GROUND, GROUND,  GROUND, GROUND,  S_W_1,  GROUND,  GROUND,  S_W_1, GROUND, GROUND, GROUND, GROUND,    G_W, GROUND,  GROUND,  S_W_1 ],
    [  S_W_1,  S_W_1,  S_W_1,  S_W_1,  S_W_1,  S_W_1,  S_W_1,   S_W_1,  S_W_1,  S_W_1,    S_W_1,  S_W_1,  S_W_1,  S_W_1,  S_W_1,  S_W_1,  S_W_1,  S_W_1,   S_W_1,  S_W_1 ],
 ];
