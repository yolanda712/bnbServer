...
```js
// 创建房间和加入房间成功后均返回roomInfo信息 传入信息为{name: room1, userInfo: {guid:aadfs12,nickName:a, avataUrl:'xxx', gender:1}}
msg = "roomInfo"
data = {
   code:1,
   data:{
...
msg = "itemEaten"
data = {
        {x:1,y:1,guid:asdkjf2123131,itemCode:101}
}
